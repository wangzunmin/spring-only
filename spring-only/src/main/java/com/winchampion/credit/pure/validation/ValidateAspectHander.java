...
@Component  
@Aspect
public class ValidateAspectHander {
	 /** 
     * 使用AOP对使用了ValidateGroup的方法进行代理校验 
     * @throws Throwable  
     */  
    @SuppressWarnings({ "finally", "rawtypes" })  
    @Around("@annotation(com.winchampion.credit.pure.validation.ValidateGroup)")  
     ...
     * 根据类和方法名得到方法 
     */  
    public Method getMethodByClassAndName(Class<? extends Object> c , String methodName){  
